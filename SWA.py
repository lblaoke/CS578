...
for epoch in range(1,num_epoch+1):
    ...
    for batch_id,(inputs,targets) in enumerate(train_loader):
        ...
        if num_batch-batch_id<100 and batch_id%10==0:
            for p_swa,p in zip(net_SWA.parameters(),net.parameters()):
                p_swa.data = (epoch*p_swa.data+p.data.detach())/(epoch+1)
